...
#ifndef IMME_IOS_SWIFT_H
#define IMME_IOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="imme_ios",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// since:
/// 1.0.0
SWIFT_PROTOCOL("_TtP8imme_ios14BarcodeParsing_")
...
/// since:
/// 1.0.0
SWIFT_CLASS("_TtC8imme_ios18AAMVABarcodeParser")
...
/// since:
/// 1.0.0
SWIFT_CLASS("_TtC8imme_ios12DocumentData")
...
SWIFT_CLASS("_TtC8imme_ios17AAMVADocumentData")
...
SWIFT_CLASS("_TtC8imme_ios19AAMVAv1DocumentData")
@interface AAMVAv1DocumentData : AAMVADocumentData
@property (nonatomic, readonly, copy) NSString * _Nullable lastName;
@end


SWIFT_CLASS("_TtC8imme_ios19AAMVAv2DocumentData")
@interface AAMVAv2DocumentData : AAMVADocumentData
@property (nonatomic, readonly, copy) NSString * _Nullable firstName;
@end


SWIFT_CLASS("_TtC8imme_ios19AAMVAv3DocumentData")
@interface AAMVAv3DocumentData : AAMVADocumentData
@property (nonatomic, readonly, copy) NSString * _Nullable firstName;
@end


SWIFT_CLASS("_TtC8imme_ios19AAMVAv4DocumentData")
@interface AAMVAv4DocumentData : AAMVADocumentData
@end


SWIFT_CLASS("_TtC8imme_ios19AAMVAv5DocumentData")
@interface AAMVAv5DocumentData : AAMVADocumentData
@end


SWIFT_CLASS("_TtC8imme_ios19AAMVAv6DocumentData")
@interface AAMVAv6DocumentData : AAMVADocumentData
@end


SWIFT_CLASS("_TtC8imme_ios19AAMVAv7DocumentData")
@interface AAMVAv7DocumentData : AAMVADocumentData
@end


SWIFT_CLASS("_TtC8imme_ios19AAMVAv8DocumentData")
...
static NSString * _Nonnull const BarcodeParserErrorDomain = @"imme_ios.BarcodeParserError";
...
SWIFT_CLASS("_TtC8imme_ios21MagStripeDocumentData")
...
@interface NSMutableString (SWIFT_EXTENSION(imme_ios))
...
SWIFT_CLASS("_TtC8imme_ios14PassportReader") SWIFT_AVAILABILITY(ios,introduced=13)
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC8imme_ios16QKMRZScannerView")
...
@interface QKMRZScannerView (SWIFT_EXTENSION(imme_ios)) <AVCaptureVideoDataOutputSampleBufferDelegate>
